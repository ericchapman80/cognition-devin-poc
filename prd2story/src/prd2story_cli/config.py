"""Configuration management for prd2story."""
...
def create_config(target_dir: Path, user_config: dict) -> dict:
    """Write configuration to .prd2story/init-options.json."""
...
def load_config(target_dir: Path) -> dict | None:
    """Load existing configuration from .prd2story/init-options.json."""
