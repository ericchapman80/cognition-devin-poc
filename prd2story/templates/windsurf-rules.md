---
trigger: always
description: "{{ORG_NAME}} Story Agent - Global instructions for creating Epics and user stories from PRDs"
---

# {{ORG_NAME}} Story Agent - Windsurf Instructions
...
> **Full agent instructions are in `.prd2story/AGENTS.md`.** This file contains the concise summary Windsurf loads at startup. For complete workflow details, formats, and quality guidelines, refer to `.prd2story/AGENTS.md`.

## Available Workflows

Type `/prd2story.` in Cascade chat to see all available commands:
...
- Story must be completable by one developer in 8-12h including tests (XS/S/M: XS=1pt, S=2pts, M=3pts)
