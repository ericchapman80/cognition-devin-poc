...
> **Full agent instructions are in `AGENTS.md`.** This file contains the concise summary Windsurf loads at startup. For complete workflow details, formats, and quality guidelines, refer to `AGENTS.md`.
